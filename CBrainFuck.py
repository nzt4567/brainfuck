...
''' bF interpreter; author: nzt4567; year: 2013 '''

# IMPORTS
import std, os.path, sys
...
if __name__ == '__main__':
  if len(sys.argv) > 1:
    ...
    std.exit_failure("INVALID_CODE", "You have executed CBrainFuck.py " +
                    "directly but without source. Better run __main__.")